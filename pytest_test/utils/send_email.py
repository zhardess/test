...
sender = '564197253@qq.com'
receivers = ['zhangzheazy@163.com', '3462208676@qq.com']
message = MIMEMultipart()
message['From'] = Header("a 564197253@qq.com")
...
smtp.login('564197253@qq.com', 'gigkpayfonfgbchc')
